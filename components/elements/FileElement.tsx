...
const type: ElementsType = "FileElement";
...
export const FileElement: EditorElement = {
    type,
    construct: (id: string) => ({
        id,
        type,
...
function PropertiesComponent({ elementInstance }: { elementInstance: EditorElementInstance }){
    ...
    const labels = ['Label','HelperText','Accept'];
    ...
    function applyChanges() {
        setFields({
            ...
            code: `
                ...
                <input 
                    ...
                    text-[${fields.font}px] font-${fields.weight} text-[${fields.color}] opacity-${fields.opacity}
        ...
        const { label, helperText, accept, color, bg, variant, required, width, height, font, weight, code, opacity,
    ...
    return (
        <Form {...form}>
            ...
            >
                {labels.map((label, index) => {
                    return(
                        <FormField
                            ...
                            name={label == 'Label' ? 'label' : label == 'Accept' ? 'accept' : 
                ...
                <div className="grid grid-cols-auto grid-rows-2 gap-4">
...
function DesignerComponent({ elementInstance }: { elementInstance: EditorElementInstance }){
    const element = elementInstance as CustomInstance;
    const { label, helperText, accept, color, bg, variant, opacity, required, width, height, font, weight,
...
function FormComponent({ elementInstance, submitValue, isInvalid, defaultValue, }: {
    ...
    const element = elementInstance as CustomInstance;
    const { label, helperText, accept, color, opacity, bg, variant, required, width, height, font, weight,
        paddingBot, paddingTop, paddingLeft, paddingRight, marginBot, marginTop, marginLeft, marginRight } = element.extraAttributes;
