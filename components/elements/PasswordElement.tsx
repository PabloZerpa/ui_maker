...
const type: ElementsType = "PasswordElement";
...
export const PasswordElement: EditorElement = {
    type,
    construct: (id: string) => ({
        id,
        type,
...
function PropertiesComponent({ elementInstance }: { elementInstance: EditorElementInstance }){
    ...
    const sizes = ['Width','Height','Minimun', 'Maximun'];
    ...
    function applyChanges() {
        ...
        const { label, helperText, placeHolder, color, bg, variant, required, width, height, font, weight, opacity, min, max, code,
...
function DesignerComponent({ elementInstance }: { elementInstance: EditorElementInstance }){
    const element = elementInstance as CustomInstance;
    const { label, helperText, placeHolder, color, bg, variant, required, width, height, font, weight, min, max, opacity,
