...
const type: ElementsType = "TextElement";
...
function PropertiesComponent({ elementInstance }: { elementInstance: EditorElementInstance }){
    ...
    function applyChanges() {
        ...
        const { label, helperText, placeHolder, color, bg, variant, required, width, height, font, weight, opacity, code,
...
function DesignerComponent({ elementInstance }: { elementInstance: EditorElementInstance }){
    const element = elementInstance as CustomInstance;
    const { label, helperText, placeHolder, color, bg, variant, required, width, height, font, weight, opacity,
    ...
    return (
        <div className="flex flex-col gap-2 w-80">
            ...
            <input 
                className={`p-3 bg-[#E0E0E0] text-[#191E24] dark:bg-[#191E24] dark:text-[#E0E0E0] border-solid border border-[#939393] rounded-lg outline-none`}
                type="text" 
